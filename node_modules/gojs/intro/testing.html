...
<!-- Copyright 1998-2022 by Northwoods Software Corporation. -->    <title> Testing GoJS apps -- Northwoods Software </title>
...
<p>
  The <a>Robot</a> extension is useful for pretending to interact with a Diagram
  without actually generating any keyboard or mouse or pointer events.
  See the sample at <a href="../extensions/Robot.html">Simulating Input with Robot</a>.
</p>
<p>
  One convenient feature of the <a>Robot</a> class is that it uses document coordinates,
  so that changes in the viewport size or diagram content alignment, scroll position, or zoom level will not affect the calls.
</p>

<h2 id="TestingwithJest">Testing with Jest</h2>

<p>
  Testing with Jest depends on installing: <code>jest</code>, <code>puppeteer</code>, and <code>jest-puppeteer</code>.
</p>
...
<p>
  In our
  <a href="https://github.com/NorthwoodsSoftware/gojs-react-samples/tree/main/gojs-react-jest">GoJS React samples</a>,
  we have an example of using the gojs-react component with Jest:
  <a href="https://github.com/NorthwoodsSoftware/gojs-react-samples/tree/main/gojs-react-jest">gojs-react-jest</a>.
</p>
