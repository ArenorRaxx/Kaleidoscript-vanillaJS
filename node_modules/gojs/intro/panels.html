...
<!-- Copyright 1998-2022 by Northwoods Software Corporation. -->    <title> GoJS Panels -- Northwoods Software </title>
...
<p>
  ...
  so we give it a name and set alignmentFocusName on the panel.
</p>
  ...
  diagram.add(
    $(go.Node, "Spot",
      ...
      $(go.Panel, "Horizontal",
          ...
          $(go.TextBlock, "some\nlong label", { margin: 8 }),
          $(go.Shape, { name: 'SHAPE', width: 20, height: 20, strokeWidth: 0, fill: 'red' },
...
<pre class="lang-js" id="StretchSpotPanels"><code>
  diagram.add(
    $(go.Part, "Spot",
      ...
      $(go.Shape, { name: 'MAIN', strokeWidth: 0, width: 80, height: 60, fill: 'rgba(255,0,0,.8)' }), // red

      $(go.Shape, { stretch: go.GraphObject.Vertical, strokeWidth: 0, width: 20, fill: 'rgba(0,255,0,.3)', // green
        alignment: go.Spot.Left,
        alignmentFocus: go.Spot.Right
      }),
      $(go.Shape, { stretch: go.GraphObject.Vertical, strokeWidth: 0, width: 20, fill: 'rgba(0,0,255,.3)' , // blue
        alignment: go.Spot.Right,
        alignmentFocus: go.Spot.Left
      }),
      $(go.Shape, { stretch: go.GraphObject.Horizontal, strokeWidth: 0, height: 20, fill: 'rgba(255,0,255,.3)' , // pink
