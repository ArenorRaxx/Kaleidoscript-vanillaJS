...
<!-- Copyright 1998-2022 by Northwoods Software Corporation. -->    <title> GoJS Building GraphObjects -- Northwoods Software </title>
...
<p>
The following pages will discuss the basic kinds of objects you can use to build Parts.
These pages build up a diagram by explicitly creating and adding nodes and links.
Later pages will show how to build diagrams using models rather than adding Parts directly.
</p>

<h2 id="BuildingBlocks">The Building Blocks of GoJS</h2>
<p>
  GoJS Diagrams display top-level <b>Parts</b> and <b>Part</b> subclasses: <b>Nodes</b>, <b>Links</b>, and <b>Groups</b>.
</p>
<p>
  <b>Parts</b> are <b>Panels</b>, which can hold any number of <b>Shapes</b>, <b>Pictures</b>, <b>TextBlocks</b>, or other, nested <b>Panels</b>.
  All together, these are subclasses of <b>GraphObject</b>.
</p>
<pre class="lang-js" id="BuildingBlocksDiagram" style="display:none"><code>
  ...
  var panelBackgroundColor = 'palegreen';
  function makepanel(type, desc) {
    return new go.Node("Vertical")
      .add(new go.TextBlock("go.Panel(\""+ type + "\")", { margin: 4, font: "13px monospace" }))
      .add(new go.Panel(type, { background: panelBackgroundColor })
        .add(sh('lightpink').set({ figure: 'RoundedRectangle' }))
        .add(sh('lightsalmon').set({ figure: 'Triangle', row: 1, width: 15, height: 15 }))
        .add(sh('lightcoral').set({ figure: 'Ellipse', column: 3, width: 25, height: 25 }))
        .add(sh('red').set({ column: 1, row: 2 }))
      )
  }

  function makepanelAuto() {
    return new go.Node("Vertical")
      .add(new go.TextBlock('go.Panel("Auto")', { margin: 4, font: "13px monospace" }))
      .add(new go.Panel("Auto", { background: panelBackgroundColor })
        .add(new go.Shape({ strokeWidth: 2, figure: 'RoundedRectangle', fill: 'lightpink' }))
        .add(new go.TextBlock('Auto Panel\'s first element\nexpands dynamically to\n fit all other elements.\nIn this case, a single TextBlock\nwith a long string.',
  ...
  function makepanelSpot() {
    return new go.Node("Vertical")
      .add(new go.TextBlock('go.Panel("Spot")', { margin: 4, font: "13px monospace" }))
      .add(new go.Panel("Spot", { background: panelBackgroundColor })
        .add(new go.Shape({ strokeWidth: 2, figure: 'RoundedRectangle', width: 50, height: 50, fill: 'lightpink' }))
        .add(sh('lightsalmon').set({ figure: 'Triangle', alignment: go.Spot.Left }))
        .add(sh('lightcoral').set({ figure: 'Ellipse', alignment: go.Spot.Right }))
        .add(sh('red').set({ alignment: go.Spot.Top }))
      )
  }
  ...
  new go.Node("Spot")
    .add(new go.Shape("RoundedRectangle", { strokeWidth: 1.5, fill: 'pink', width: 90, height: 30 }))
    .add(new go.TextBlock({ font: "16px san-serif" }).bind('text', 'key'))
  )


diagram.nodeTemplateMap.add('TextBlock',
  new go.Node("Vertical")
    .add(new go.TextBlock('go.TextBlock("Some Text")',
    { spacingBelow: 4, font: "13px monospace" }))
    .add(new go.TextBlock("Some Text", { font: "26px serif" }))
  )

  diagram.nodeTemplateMap.add('Picture',
  new go.Node("Vertical")
    .add(new go.TextBlock('go.Picture("images/55x55.png")',
    { spacingBelow: 4, font: "13px monospace" }))
    .add(new go.Picture("images/55x55.png", { width: 50, height: 50 }))
  )

  diagram.nodeTemplateMap.add('Shape',
  new go.Node("Vertical")
    .add(new go.TextBlock('go.Shape("Triangle")',
    { spacingBelow: 4, font: "13px monospace" }))
    .add(new go.Shape("Triangle", { width: 50, height: 50, fill: '#00FAFA' }))
  )

  diagram.nodeTemplateMap.add('Panel',
  new go.Node("Vertical")
    .add(new go.TextBlock('go.Panel("[PanelType]")',
    { spacingBelow: 4, font: "13px monospace", margin: 2 }))
    .add(new go.TextBlock("Panels have no visual unless\na background is specified.\nThey hold other GraphObjects,\nand can be nested.",{
      textAlign: 'center'
    }))
  )
  ...
  new go.Node("Vertical")
    .add(new go.TextBlock('go.Node("[PanelType]")',
    { spacingBelow: 4, font: "13px monospace", margin: 2 }))
    .add(new go.TextBlock("Nodes can connect with links\n and be members of a Group.",{
      textAlign: 'center'
    }))
  )
  ...
  diagram.groupTemplate = new go.Group("Vertical", {
    ...
    .bind("layout")
    .bind("location", "loc")
    .add(new go.TextBlock({ margin: 4, font: '13pt sans-serif' }).bind("text"))
    .add(new go.Panel("Auto")
      .add(new go.Shape("RoundedRectangle", { fill: 'whitesmoke', stroke: 'darkgray' }))
...
<script>goCode("BuildingBlocksDiagram", 750, 750)</script>

<p>
<b>Nodes</b> and <b>Links</b> are usually composed of many GraphObjects, including several <a>Panel</a>s that may be nested.
</p>
...
<p>
This code produces the following diagram.  It is a "live" diagram,
...
<ul>
  <li>
    TextBlock: The <a>TextBlock.text</a> - for example, <code>new go.TextBlock("Hello")</code>
  </li>
  <li>
    Picture: The <a>Picture.source</a> - for example, <code>new go.Picture("https://example.com/image1.png")</code>
  </li>
  <li>
    Shape: The <a>Shape.figure</a> - for example, <code>new go.Shape("RoundedRectangle")</code>
  </li>
  <li>
    Panel: The <a>panel.type</a> as a string  - for example, <code>new go.Panel("Auto")</code>. Possible values are "Position", "Vertical", "Horizontal", "Auto", "Spot", "Table", and a few specialty panels. See the page on <a href="panels.html">Panels</a> for more.
  </li>
  <li>
    Nodes, Parts, and Groups all inherit from Panel, and take the same constructor argument.
  </li>
  <li>
...
<p>
  Every GraphObject additionally takes an optional constructor argument that is a JavaScript object, which can be used to set any object properties. For exmaple, instead of writing:
</p>
...
<p>
The first argument is the Shape.figure, the second argument is an object setting other Shape properties.
...
<p><em>Unlike building with .add, GraphObject.make is not well type-checked when using TypeScript definitions. However, it is more flexible, and many of our samples use it.</em></p>
