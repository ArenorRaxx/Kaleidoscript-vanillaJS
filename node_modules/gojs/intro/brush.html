...
<!-- Copyright 1998-2022 by Northwoods Software Corporation. -->    <title> GoJS Brushes -- Northwoods Software </title>
...
<p>Radial gradient brushes can be controlled with <a>Brush.startRadius</a> and <a>Brush.endRadius</a>, which default to zero and NaN, respectively, meaning the gradient begins at the very center and goes to the farthest measured edge of the object.
