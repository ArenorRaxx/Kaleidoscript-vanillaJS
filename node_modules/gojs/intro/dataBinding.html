...
<!-- Copyright 1998-2022 by Northwoods Software Corporation. -->    <title> GoJS Data Binding -- Northwoods Software </title>
...
The <a>Panel.itemTemplate</a> of the Panel whose <a>Panel.itemArray</a> is bound to that Array is defined
so as to show a Panel with a RoundedRectangle Shape surrounding a Vertical Panel showing Picture over a TextBlock.
</p>
<p>
The green dashed links show how the Binding transfers the property value from the data Object
to the Picture or TextBlock GraphObject in the Node.
</p>
...
diagram.nodeTemplateMap.add("ItemArrayTable",
    $(go.Node, "Auto", new go.Binding("location", "position", go.Point.parse),
        ...
        $(go.Panel, "Auto", {margin: 3, portId: "rightSide", toSpot: go.Spot.Right},
            ...
            $(go.Panel, "Vertical",
                $(go.Panel, "Auto", {stretch: go.GraphObject.Fill, portId: "itemArrayText", fromSpot: go.Spot.Right},
                    $(go.Shape, "Rectangle", {fill: "lightgoldenrodyellow", strokeWidth: 0}),
                    $(go.TextBlock, "Item Array", {margin: 2}),
                ),
                $(go.Shape, "LineH", {height: 2, stretch: go.GraphObject.Fill}),
...
diagram.linkTemplateMap.add("Comment",
    $(go.Link, {curve: go.Link.Bezier, curviness: -30},
...
diagram.linkTemplateMap.add("ReferenceLink",
    $(go.Link, new go.Binding("curviness"), {curve: go.Link.Bezier},
        $(go.Shape, {strokeWidth: 1.5}),
        $(go.Shape, {toArrow: "Boomerang"}),
        $(go.Panel, "Auto",
            $(go.Shape, "Rectangle", {fill: "lightskyblue"}),
...
createNodeItemArrayTable(diagram.model.nodeDataArray[1]);
for (let i = 0; i < diagram.model.nodeDataArray.length; i++)
    createItemDataTable(diagram.model.nodeDataArray[1].items[i]);
</code></pre>
<script>goCode("commented2", 700, 640)</script>
